...
# Second Plot Idea
Okay, so that was fun to try, but ultimately it doesn't work. It's just too busy. I tried a few more things (coloring lines to match large end-circles, extending the range) and nothing worked. Time to retire graph number one. 

Still, now I have both neighborhood data and program data. I can make address-level data fairly easily as well. I just need an idea. And an idea, I have not. 
